...
<head>
    ...
    <title>GPI PAPUA BUKIT ZAITUN JAYAPURA| Halaman Login</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Email Anda">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('Mendaftar') ?>">Buat Akun Baru!</a>
                                    </div>
                                </div>
                            </div>
                        </div>

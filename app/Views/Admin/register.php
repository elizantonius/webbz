...
<head>
    ...
    <title>GPI PAPUA BUKIT ZAITUN JAYAPURA| Halaman Pendaftaran</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Menadaftar!</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Anda">
                                </div>
                                <div class="form-group">
